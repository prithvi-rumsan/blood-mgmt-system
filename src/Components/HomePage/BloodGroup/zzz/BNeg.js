...
export default function App() {
    return (       
        <div className="row mb-2 p-2" style={{backgroundColor:'#f9dc77ff'}}>
            <div className="col-md-2 blood-group-container d-flex align-items-center">
                <button data-toggle="dropdown" className="btn btn-md dropdown-toggle btn-blood-group" style={{fontSize:'16px',fontWeight:'800'}}>B- Negative</button>
