...
export default function App() {
    ...
    return (       
        <div className="row mb-2 p-2" style={{backgroundColor:'#a4cc29ff'}}>
            <div className="col-md-2 blood-group-container d-flex align-items-center">
                <button data-toggle="dropdown" className="btn btn-md dropdown-toggle btn-blood-group" style={{fontSize:'16px',fontWeight:'800'}}>A+ Positive</button>
                <ul className="dropdown-menu">
                <li><a className="dropdown-item" href="#" onClick={()=>{console.log('all zeroes')}}>Fill
                    all Zeros</a></li>
                </ul>
            </div>
            ...
            <div className="col-6 col-md text-center">
                <label htmlFor="date" style={{color:'#333'}}>WB</label>
                <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                    ...
                    <input type="number" className="form-control input-item" data-group="WB" name="a_pos" onChange={(e) => dataChange(e)}/>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>PRBC</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>PRP</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>PC</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>FFP</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>CRY</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>LPRC</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
            ...
            <div className="col-6 col-md text-center">
            <label htmlFor="date" style={{color:'#333'}}>TOTAL</label>
            <div className="input-group m-b number-spinner"><span className="input-group-prepend d-block d-sm-block d-md-none">
                <button type="button" className="btn btn-default btn-number-spinner" data-dir="dwn"><span className="fa fa-chevron-down"></span></button> </span>
